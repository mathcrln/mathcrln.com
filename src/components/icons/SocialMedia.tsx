...
export function GithubLogo({ className = '', href }: { className?: string; href: string }): JSX.Element {
	return (
...
export function LinkedinLogo({ className = '', href }: { className?: string; href: string }): JSX.Element {
	return (
		<a href={href} target='_BLANK' rel='noreferrer'>
			<svg
				className={`fill-current text-black dark:text-white ${SIZE} ${className}`}
...
export function TwitterLogo({ className = '', href }: { className?: string; href: string }): JSX.Element {
	return (
		<a href={href} target='_BLANK' rel='noreferrer'>
			<svg
