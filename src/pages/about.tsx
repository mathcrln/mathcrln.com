				...
				<div className=' mx-auto my-20 lg:max-w-[1200px]'>
					<div className='grid lg:grid-cols-[1fr,1fr] gap-10 items-center'>
						...
						<div className='text-md space-y-6 '>
							...
							<p>
								Looking for me ? You’ll usually find me either creating or learning and sharing the insights I
								find either on my blog, newsletter or podcast.
							</p>
						</div>
					</div>
				</div>
				<div className=' mx-auto my-20 lg:max-w-[1200px]'>
					<div className='grid lg:grid-cols-[1fr,1fr] gap-10 items-center'>
						<div className='text-md space-y-6 '>
							...
							<p>
								A couple decades ago, I was born in <strong>Martinique</strong>, a tiny, yet beautiful and warm
