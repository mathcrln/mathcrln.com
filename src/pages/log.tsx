		...
		>
			...
			<section className='my-16'>
				<div className='border-primary-light dark:border-primary-dark border-l-4 border-solid px-6'>
					<h2 className='text-xl font-bold bg-primary-dark w-max px-4 py-2 ml-[-1.7rem]  rounded'>2021</h2>

					<div className='my-12'>
						<h2 className='font-bold text-xl relative before:absolute before:left-[-2.25rem] before:bg-white before:border-primary-light dark:before:border-primary-dark before:border-solid before:border before:w-5 before:h-5 before:rounded-full'>
					...
					<p className='text-gray-400 italic relative before:absolute before:left-[-2rem] before:bottom-0 before:bg-primary-dark before:border-primary-light dark:before:border-primary-dark before:border-solid before:border before:w-3 before:h-3 align-baseline leading-none'>
