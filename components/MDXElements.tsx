...
const H3 = ({ children }: { children: string }): JSX.Element => <h3 className='mt-10 mb-8 text-2xl font-bold'>{children}</h3>;

const H4 = ({ children }: { children: string }): JSX.Element => <h4 className='mt-10 mb-6 text-xl font-semibold'>{children}</h4>;
const H5 = ({ children }: { children: string }): JSX.Element => <h5 className='mt-10 mb-4 text-lg font-semibold'>{children}</h5>;
